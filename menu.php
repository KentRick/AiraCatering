...
<body>
          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 profile-menu">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" id="username"> <i class="fas fa-user fa-fw"></i> <?php echo htmlspecialchars($username); ?></a></li>
  ...
  #menu-grid {
      ...
      margin-bottom: 40px; /* Adjust this value to control the space above the footer */
  }
  ...
  #menu-grid .grid-container {
      ...
      grid-template-rows: repeat(3, auto); /* Automatic row height based on content */
