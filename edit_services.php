      ...
      <table style="width:100%; margin-top: 20px;">
        ...
        while ($row = $result->fetch_assoc()): ?>
          <tr>
            ...
            <td class="actions">
              <button class="btn btn-link edit-btn" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?php echo $row['id']; ?>"><i class="edit-icon">&#9998;</i>Edit</button>
              <button class="btn btn-link delete-btn" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?php echo $row['id']; ?>"><i class="delete-icon">&#128465;</i>Delete</button>
            </td>
          </tr>
        <?php endwhile; ?>
      </table>
