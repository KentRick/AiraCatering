    ...
    (a.prototype.onDragMove = function (t) {
      ...
      this.state.isTouch &&
        ...
        (this.drag.distance > 8 || this.drag.distance < -8) &&
          (s !== i.preventDefault ? i.preventDefault() : (i.returnValue = !1),
    ...
    (a.prototype.onDragEnd = function (e) {
      ...
      if (this.state.isTouch) {
        ...
        (this.drag.endTime = new Date().getTime()),
          ...
          ((n = Math.abs(this.drag.distance)) > 3 || s > 300) &&
      ...
      this.trigger("translate"),
        ...
        this.support3d
          ? this.$stage.css({
              ...
              transition:
                this.speed() / 1e3 + "s " + this.settings.slideTransition,
            })
          : this.state.isTouch
        ...
        (this.handlers = {
          ...
          "mouseleave.owl.autoplay": t.proxy(function () {
            this.core.settings.autoplayHoverPause &&
              0 == this.core.$element.find(".owl-video-playing").length &&
              this.autoplay();
          }, this),
        }),
        this.core.$element.on(this.handlers);
    ...
    (n.Defaults = {
      ...
      (n.prototype.initialize = function () {
        ...
        (this._controls.$indicators = s.dotsContainer
          ? t(s.dotsContainer)
          : t("<div>").hide().addClass(s.dotsClass).appendTo(this.$element)),
      ...
      (n.prototype.draw = function () {
        ...
        if (
          ...
          if (
            ...
            e > 0
              ? ((s = Array(e + 1).join(this._templates[0])),
