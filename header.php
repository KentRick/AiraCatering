...
<ul class="navbar-nav ms-auto mb-2 mb-lg-0 profile-menu">
    <?php if (isset($_SESSION['first_name'])): // Check if session exists ?>
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                    <a class="dropdown-item" id="username">
                        ...
                        <?php echo htmlspecialchars($_SESSION['first_name'] . ' ' . (isset($_SESSION['last_name']) ? htmlspecialchars($_SESSION['last_name']) : '')); ?>
                    </a>
                </li>
